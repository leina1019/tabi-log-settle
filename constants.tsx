...
export const DEVICE_CONFIG = {
  'phone': { label: 'iPhone', icon: 'device-phone', width: 'max-w-[390px]', description: '標準的なスマホ' },
  'phone-l': { label: 'iPhone Max', icon: 'device-phone', width: 'max-w-[430px]', description: '大きめのスマホ' },
  'tablet-s': { label: 'iPad mini', icon: 'device-tablet', width: 'max-w-[744px]', description: 'iPad mini (縦)' },
  'tablet-m': { label: 'iPad Air', icon: 'device-tablet', width: 'max-w-[820px]', description: 'iPad (縦)' },
  'tablet-l': { label: 'iPad Pro', icon: 'device-laptop', width: 'max-w-[1024px]', description: 'iPad Pro / PC' },
} as const;
