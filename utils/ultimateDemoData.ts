...
export const ULTIMATE_ITINERARY: ItineraryItem[] = [
    ...
    { id: 'd1-1', date: d(0), time: '07:30', title: '羽田空港 集合', location: 'Haneda Airport Terminal 3', type: 'move', mapUrl: 'https://maps.app.goo.gl/haneda', participantId: undefined },
    ...
    { id: 'd1-5', date: d(0), time: '20:00', title: '夕食：近くのブーランジェリー', location: 'Rue de Rivoli', type: 'meal', memo: 'ReinaとKenのみで軽く。', participantId: 'Reina' },

    // Day 2 (Hana Join)
    { id: 'd2-1', date: d(1), time: '08:30', title: '優雅なホテルの朝食', location: 'Le Meurice breakfast room', type: 'meal', memo: 'Hana到着を待つ', participantId: 'Ken' },
...
export const ULTIMATE_EXPENSES: Expense[] = [
    { id: 'uexp-1', date: d(0), title: '航空券一括支払い (HND-CDG往復)', amount: 300000, currency: 'JPY', exchangeRate: 1, paidBy: 'Ken', splitWith: ['Reina', 'Ken'], category: '交通費', createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
    { id: 'uexp-2', date: d(1), title: 'パリ ホテル 3泊分', amount: 900, currency: 'EUR', exchangeRate: 165, paidBy: 'Reina', splitWith: ['Reina', 'Ken', 'Hana'], category: '宿泊費', createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
    { id: 'uexp-3', date: d(1), title: '合流後のお祝いランチ', amount: 150, currency: 'EUR', exchangeRate: 165, paidBy: 'Hana', splitWith: ['Reina', 'Ken', 'Hana'], category: '食事', createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
    { id: 'uexp-4', date: d(2), title: 'ルーヴル美術館 共通チケット', amount: 66, currency: 'EUR', exchangeRate: 165, paidBy: 'Ken', splitWith: ['Reina', 'Ken', 'Hana'], category: '観光', createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
    { id: 'uexp-5', date: d(3), title: 'ユーロスター プレミアムチケット', amount: 540, currency: 'GBP', exchangeRate: 195, paidBy: 'Reina', splitWith: ['Reina', 'Ken', 'Hana'], category: '交通費', createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
    { id: 'uexp-6', date: d(0), title: '空港までのタクシー', amount: 12000, currency: 'JPY', exchangeRate: 1, paidBy: 'Ken', splitWith: ['Ken'], category: '交通費', createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
];
...
export const ULTIMATE_TICKETS: Ticket[] = [
    ...
    { id: 'utix-2', type: 'flight', title: 'ベルリン-パリ 片道 (Hana用)', provider: 'Lufthansa', date: d(1), time: '08:00', passengerIds: ['Hana'], referenceNumber: 'HANA-LH', notes: '現地集合。CDG到着後にタクシーでホテルへ' },
    { id: 'utix-3', type: 'hotel', title: 'パリ：ル・ムーリス (3泊)', provider: 'Le Meurice', date: d(0), referenceNumber: 'PARIS-STAY-MEU', notes: 'Reinaの名前で予約' },
    { id: 'utix-4', type: 'train', title: 'ユーロスター (パリ->ロンドン)', provider: 'Eurostar', date: d(3), time: '10:13', passengerIds: ['Reina', 'Ken', 'Hana'], notes: ' Coach 01, Seats 11-13' },
];
...
export const ULTIMATE_PACKING: PackingItem[] = [
    ...
    { id: 'up-2', category: '必需品', title: 'eSIMの設定', isPacked: false, assignees: ['Reina', 'Ken', 'Hana'], updatedAt: new Date().toISOString() },
    { id: 'up-3', category: '電子機器', title: '変圧器(Cタイプ)', isPacked: true, assignees: ['Ken'], updatedAt: new Date().toISOString() },
    { id: 'up-4', category: '書類', title: 'ユーロスター控え', isPacked: false, assignees: ['Reina'], updatedAt: new Date().toISOString() },
];
